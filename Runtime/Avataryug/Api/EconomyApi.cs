...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IEconomyApi
    {
        ...
        void GetEconomyBundles(Action<GetEconomyBundlesResult> result, Action<ApiException> error);
        /// <summary>
        ...
        void GetEconomyContainers(Action<GetEconomyContainersResult> result, Action<ApiException> error);
        ///// <summary>
        ///// Get Economy Items Get Economy Items
        ///// </summary>
        ///// <returns>GetEconomyItemsResult</returns>
        //void GetEconomyItems(Action<GetEconomyItemsResult> result, Action<ApiException> error);
        /// <summary>
        /// Get Economy Items Get Economy Items
        /// </summary>
        ...
        void GetEconomyStores(Action<GetEconomyStoresResult> result, Action<ApiException> error);
        /// <summary>
    ...
    public class EconomyApi : IEconomyApi
    {
        ...
        /// </summary>
        /// <returns>GetEconomyBundlesResult</returns>
        public async void GetEconomyBundles(Action<GetEconomyBundlesResult> result, Action<ApiException> error)
        {
            if (!Configuration.ProjectIdPresent)
            {
                UnityEngine.Debug.LogError("ProjectId is not present");
        ...
        /// </summary>
        /// <returns>List&lt;GetEconomyContainersResultInner&gt;</returns>
        public async void GetEconomyContainers(Action<GetEconomyContainersResult> result, Action<ApiException> error)
        {
            if (!Configuration.ProjectIdPresent)
            {
                UnityEngine.Debug.LogError("ProjectId is not present");
        ...
        public async void GetEconomyItems(string category, int status, int gender, Action<GetEconomyItemsResult> result, Action<ApiException> error)
        {
            ...
            if (status == null) throw new ApiException(400, "Missing required parameter 'status' when calling GetEconomyItems");

            // verify the required parameter 'gender' is set
            if (gender == null) throw new ApiException(400, "Missing required parameter 'gender' when calling GetEconomyItems");
        ...
        /// </summary>
        /// <returns>GetEconomyStoresResult</returns>
        public async void GetEconomyStores(Action<GetEconomyStoresResult> result, Action<ApiException> error)
        {
            if (!Configuration.ProjectIdPresent)
            {
                UnityEngine.Debug.LogError("ProjectId is not present");
