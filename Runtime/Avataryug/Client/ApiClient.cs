...
namespace Org.OpenAPITools.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath = "https://projectid.avataryugapi.com/client")
        {
            BasePath = "https://" + Configuration.ProjectId + ".avataryugapi.com/client";
       ...
       Dictionary<String, FileParameter> fileParams, String[] authSettings)
        {
            ...
            return (Object)await taskCompletionSource.Task;
        }
