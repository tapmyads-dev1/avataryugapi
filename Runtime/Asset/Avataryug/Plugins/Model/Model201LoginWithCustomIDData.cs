...
namespace Org.OpenAPITools.Model {
  ...
  /// </summary>
  [DataContract]
  public class Model201LoginWithCustomIDData {
    /// <summary>
    ...
    public List<Model201LoginWithCustomIDDataLinkedAccountsInner> LinkedAccounts { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class Model201LoginWithCustomIDData {\n");
